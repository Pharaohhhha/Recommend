...
<html lang="zh-CN">
  ...
  <body>
		...
		<div class="col-md-9 div_main">
			<div class="banner" id="b04">
				...
				<a href="javascript:void(0);" class="arrow prev">
					<img id="al" src="${ pageContext.request.contextPath }/static/img/main/arrowl.png" alt="prev" width="20" height="35">
				</a>

				<a href="javascript:void(0);" class="arrow next">
					<img id="ar" src="${ pageContext.request.contextPath }/static/img/main/arrowr.png" alt="next" width="20" height="37">
				</a>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		$('.unslider-arrow,.arrow').click(function() {
