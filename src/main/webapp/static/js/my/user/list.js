...
$(function () {
    ...
    $("#btn_import").click(function () {
        var file_warning = $("#file_warning").text("");
        var file_name = $("#file_name").text("只支持xls文件");
        var file_img = $("#file_img").attr("src","");
...
function verifyFile() {
    ...
    var options = {
        url:"verifyFile?timenow=" + timenow,
        type:"POST",
        async: false,
        dataType:"json",
