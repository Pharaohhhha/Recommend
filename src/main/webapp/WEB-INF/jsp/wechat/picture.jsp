			...
			<form enctype="multipart/form-data" method="post" action="#">
				...
				<div class="form-group" style="height:230px;">
					<div style="width:150px; height:200px; margin:10px auto; padding-top:35px; ">
						...
						<span id="span_warning" style="font-size: 14px;">请您上传正脸图片</span>
					</div>
				</div>


				<div class="form-group" style="padding-bottom:15px; ">
					<div style="width:100%; height:35px; background:#FA1616; color:#FFF; border:none; border-radius:4px; text-align:center; position:relative" id="div_picture">上传用户头像
						<a href="#" style="display:block; width:100%"  >
							<input type="file" style="position:absolute; left:0; top:0; opacity:0; filter:alpha(opacity=0); width:100%;"  onchange="imgPreview(this)" id="input_picture">
						</a>
					</div>
				</div>
